    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page never made it to the runway.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight">Turbulence detected</h1>
        <p className="mt-2 text-sm text-muted-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FlightSphere Academy — Aviation & Aerospace Coaching" },
      { name: "description", content: "World-class coaching for pilots, cabin crew, ground staff and aerospace careers. Your journey to the skies begins here." },
      { name: "author", content: "FlightSphere Academy" },
          ...
          "@graph": [
            {
              ...
              url: "/",
              description: "Premium aviation and aerospace coaching institute for pilots, cabin crew, ground staff and aerospace professionals.",
